 ...
 */
public class EditReceptionist extends javax.swing.JFrame {

    /**
     * Creates new form EditReceptionist
     */
    int usertype=0;
    ...
    private void initComponents() {
        ...
        setTitle("Custormize Receptionist");
        setResizable(false);
        ...
        jPanel1.add(txtreceptionistid, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 60, -1));
        ...
        jPanel1.add(txtreceptionistname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 320, -1));
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select * from receptionistdetails where ReceptionistID='" + txtreceptionistid.getText() + "'");
            while (rs.next()) {
                txtreceptionistname.setText(rs.getString("ReceptionistName"));
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        try {
            ...
            ResultSet rs1=s1.executeQuery("SELECT UserID FROM receptionistdetails WHERE ReceptionistID='"+txtreceptionistid.getText()+"'");
            ...
            s3.executeUpdate("DELETE FROM receptionistdetails WHERE ReceptionistID='"+txtreceptionistid.getText()+"'");
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try {
            ...
            s.executeUpdate("UPDATE receptionistdetails set ReceptionistName='" + txtreceptionistname.getText() + "',Address='" + txtaddress.getText() + "',DOB='" + txtsetdate.getText() + "',NIC='" + txtnic.getText() + "',Gender='" + gender + "',TeleNo='" + txtteleno.getText() + "' where ReceptionistID='" + txtreceptionistid.getText() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditReceptionist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditReceptionist().setVisible(true);
            }
        });
    }
